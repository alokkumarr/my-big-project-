...
ALTER TABLE CUSTOMERS ADD CONSTRAINT CUSTOMERS_FK_1 FOREIGN KEY (LANDING_PROD_SYS_ID) REFERENCES PRODUCTS(PRODUCT_SYS_ID) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE CUSTOMER_PRODUCT_MODULES ADD CONSTRAINT CUSTOMER_PRODUCT_MODULES_FK_1 FOREIGN KEY (CUST_PROD_SYS_ID) REFERENCES CUSTOMER_PRODUCTS(CUST_PROD_SYS_ID) ON DELETE CASCADE ON UPDATE CASCADE;
