...
class RowColumnFieldsAvailable {
	...
	public static SearchSourceBuilder rowColumnFieldsAvailable(List<RowField> rowfield, List<ColumnField> columnFields, List<DataField> dataFields,
			 SearchSourceBuilder searchSourceBuilder, BoolQueryBuilder boolQueryBuilder)
	{
	    	if (rowfield.size()==1)
	    	{
	    		searchSourceBuilder = rowColumnFieldsAvailableRowFieldOne(rowfield, columnFields, dataFields, searchSourceBuilder, boolQueryBuilder);	
	    	} // end of rowfield.size()==1
	    	
	    	
	    	if (rowfield.size()==2)
	    	{
	    	   searchSourceBuilder = rowColumnFieldsAvailableRowFieldTwo(rowfield, columnFields, dataFields, searchSourceBuilder, boolQueryBuilder);
	    	}// end of rowfield.size()==2
	    	
	    	if (rowfield.size()==3)
	    	{
		    	   searchSourceBuilder = rowColumnFieldsAvailableRowFieldThree(rowfield, columnFields, dataFields, searchSourceBuilder, boolQueryBuilder);	    		
	    		
	    	}// end of rowfield.size()==3
	    	if (rowfield.size()==4)
	    	{
	    		searchSourceBuilder = rowColumnFieldsAvailableRowFieldFour(rowfield, columnFields, dataFields, searchSourceBuilder, boolQueryBuilder);
	    	} // end of rowfield.size()==4
	    	
	    	if (rowfield.size()==5)
	    	{
	    		searchSourceBuilder = rowColumnFieldsAvailableRowFieldFive(rowfield, columnFields, dataFields, searchSourceBuilder, boolQueryBuilder);
	...
	private static SearchSourceBuilder rowColumnFieldsAvailableRowFieldOne(List<RowField> rowfield, List<ColumnField> columnFields, 
	...
	private static SearchSourceBuilder rowColumnFieldsAvailableRowFieldTwo(List<RowField> rowfield, List<ColumnField> columnFields, 
			List<DataField> dataFields, SearchSourceBuilder searchSourceBuilder, BoolQueryBuilder boolQueryBuilder)
	{
	...
	private static SearchSourceBuilder rowColumnFieldsAvailableRowFieldThree(List<RowField> rowfield, List<ColumnField> columnFields, 
			List<DataField> dataFields, SearchSourceBuilder searchSourceBuilder, BoolQueryBuilder boolQueryBuilder)
	{
	...
	private static SearchSourceBuilder rowColumnFieldsAvailableRowFieldFour(List<RowField> rowfield, List<ColumnField> columnFields, 
			List<DataField> dataFields, SearchSourceBuilder searchSourceBuilder, BoolQueryBuilder boolQueryBuilder)
	{
	...
	private static SearchSourceBuilder rowColumnFieldsAvailableRowFieldFive(List<RowField> rowfield, List<ColumnField> columnFields, 
			List<DataField> dataFields, SearchSourceBuilder searchSourceBuilder, BoolQueryBuilder boolQueryBuilder)
	{
