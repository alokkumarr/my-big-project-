        ...
        if (dataFields.size() == 2) {
          searchSourceBuilder.query(boolQueryBuilder).aggregation(
              AggregationBuilders
                  ...
                  .subAggregation(
                      QueryBuilderUtil
                          .aggregationBuilder(columnFields.get(0), dataFields, "column_level_1")
                          .subAggregation(
                              QueryBuilderUtil.aggregationBuilderDataField(dataFields.get(0)))
                          .subAggregation(
              ...
              AggregationBuilders
                  ...
                  .subAggregation(
                      QueryBuilderUtil.aggregationBuilder(columnFields.get(0), dataFields,
                          ...
                          .subAggregation(
                              QueryBuilderUtil
                                  .aggregationBuilder(columnFields.get(1), dataFields,
                                      "column_level_2")
                                  .subAggregation(
                                      QueryBuilderUtil.aggregationBuilderDataField(dataFields
                                          .get(0)))
                                  .subAggregation(
                                      QueryBuilderUtil.aggregationBuilderDataField(dataFields
                                          .get(1))))));
                  ...
                  .subAggregation(
                      QueryBuilderUtil.aggregationBuilder(columnFields.get(0), dataFields,
                          ...
                          QueryBuilderUtil.aggregationBuilder(columnFields.get(1), dataFields,
                              "column_level_2").subAggregation(
                              QueryBuilderUtil
                                  .aggregationBuilder(columnFields.get(2), dataFields,
                                      "column_level_3")
                                  .subAggregation(
                                      QueryBuilderUtil.aggregationBuilderDataField(dataFields
                                          .get(0)))
                      ...
                      QueryBuilderUtil.aggregationBuilder(columnFields.get(0), dataFields,
                          ...
                          QueryBuilderUtil.aggregationBuilder(columnFields.get(1), dataFields,
                              ...
                              QueryBuilderUtil.aggregationBuilder(columnFields.get(2), dataFields,
                                  "column_level_3").subAggregation(
                                  QueryBuilderUtil
                                      .aggregationBuilder(columnFields.get(3), dataFields,
                                          "column_level_4")
                                      .subAggregation(
                                          QueryBuilderUtil.aggregationBuilderDataField(dataFields
                                              .get(0)))
                              ...
                              QueryBuilderUtil.aggregationBuilder(columnFields.get(2), dataFields,
                                  ...
                                  QueryBuilderUtil.aggregationBuilder(columnFields.get(3),
                                      ...
                                      QueryBuilderUtil.aggregationBuilder(columnFields.get(4),
                                          dataFields, "column_level_5").subAggregation(
                                          QueryBuilderUtil.aggregationBuilderDataField(dataFields
                                              .get(0)))))))));
        }// dataFields.size() == 1
                              ...
                              QueryBuilderUtil.aggregationBuilder(columnFields.get(2), dataFields,
                                  ...
                                  .subAggregation(
                                      QueryBuilderUtil.aggregationBuilder(columnFields.get(3),
                                          dataFields, "column_level_4").subAggregation(
                                          QueryBuilderUtil
                                              .aggregationBuilder(columnFields.get(4), dataFields,
                                                  "column_level_5")
                                              .subAggregation(
                                                  QueryBuilderUtil
              ...
              AggregationBuilders
                  ...
                  .subAggregation(
                      AggregationBuilders
                          ...
                          .subAggregation(
                              QueryBuilderUtil
                                  .aggregationBuilder(columnFields.get(0), dataFields,
                                      "column_level_1")
                                  .subAggregation(
                                      QueryBuilderUtil.aggregationBuilderDataField(dataFields
                                          .get(0)))
                                  ...
                                  QueryBuilderUtil.aggregationBuilder(columnFields.get(1),
                                      ...
                                      QueryBuilderUtil.aggregationBuilder(columnFields.get(2),
                                          ...
                                          QueryBuilderUtil.aggregationBuilder(columnFields.get(3),
                                              dataFields, "column_level_4").subAggregation(
                                              QueryBuilderUtil
                                                  .aggregationBuilder(columnFields.get(4),
                                                      dataFields, "column_level_5").subAggregation(
                                                      QueryBuilderUtil
                                                          .aggregationBuilderDataField(dataFields
                                                              .get(0))))))))));
                                  ...
                                  .subAggregation(
                                      QueryBuilderUtil.aggregationBuilder(columnFields.get(0),
                                          ...
                                          QueryBuilderUtil.aggregationBuilder(columnFields.get(1),
                                              dataFields, "column_level_2").subAggregation(
                                              QueryBuilderUtil
                                                  .aggregationBuilder(columnFields.get(2),
                                                      dataFields, "column_level_3").subAggregation(
                                                      QueryBuilderUtil
                                                          .aggregationBuilderDataField(dataFields
                                                              .get(0)))))))));
                              ...
                              AggregationBuilders
                                  ...
                                  .subAggregation(
                                      AggregationBuilders
                                          ...
                                          .subAggregation(
                                              QueryBuilderUtil
                                                  .aggregationBuilder(columnFields.get(0),
                                                      dataFields, "column_level_1").subAggregation(
                                                      QueryBuilderUtil
                                                          .aggregationBuilderDataField(dataFields
                                                              .get(0))))))));
