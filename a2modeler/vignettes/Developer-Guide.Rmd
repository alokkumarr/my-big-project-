...
The model child class is assigned in the constructor below. A look up to the model_method dataset is made and class extracted and assigned in the `structure` function. 
