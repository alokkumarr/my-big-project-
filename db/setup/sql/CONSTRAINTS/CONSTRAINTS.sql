...
ALTER TABLE PRIVILEGE_GROUP_CODES ADD CONSTRAINT PRIVILEGE_GROUP_CODES_FK_2 FOREIGN KEY (PRIVILEGE_SYS_ID) REFERENCES `PRIVILEGES`(PRIVILEGE_SYS_ID) ON DELETE CASCADE ON UPDATE CASCADE;
