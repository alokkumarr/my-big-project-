...
ALTER TABLE SEC_GROUP CHANGE COLUMN `SEC_GROUP_SYS_ID` `SEC_GROUP_SYS_ID` BIGINT(20) NOT NULL AUTO_INCREMENT , ADD PRIMARY KEY (`SEC_GROUP_SYS_ID`);

ALTER TABLE `SEC_GROUP_DSK_ATTRIBUTE` CHANGE COLUMN `SEC_GROUP_DSK_ATTRIBUTE_SYS_ID` `SEC_GROUP_DSK_ATTRIBUTE_SYS_ID` BIGINT(20) NOT NULL AUTO_INCREMENT ,
ADD INDEX `FK_SEC_GROUP_ID_idx` (`SEC_GROUP_SYS_ID` ASC), ADD PRIMARY KEY (`SEC_GROUP_DSK_ATTRIBUTE_SYS_ID`);
...
ALTER TABLE `sec_group_dsk_value` CHANGE COLUMN `SEC_GROUP_DSK_VALUE_SYS_ID` `SEC_GROUP_DSK_VALUE_SYS_ID` BIGINT(20) NOT NULL AUTO_INCREMENT , ADD PRIMARY KEY (`SEC_GROUP_DSK_VALUE_SYS_ID`), ADD INDEX `FK_SEC_GROUP_DSK_ATTRIBUTE_SYS_ID_idx` (`SEC_GROUP_DSK_ATTRIBUTE_SYS_ID` ASC);
