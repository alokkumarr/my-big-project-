...
Branding Logo/Image can be of format (JPG, JPEG, PNG) and the size of
the file cannot exceed the value provided while including configuration

Branding color is a six-digit, three-byte hexadecimal number 
specified with notation using a leading number
