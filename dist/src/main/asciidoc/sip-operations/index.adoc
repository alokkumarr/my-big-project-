...
sip-nodes gracefully if exists , in case mapr ticket setting require to setup
with respect to any chnages in mapr cluster below steps can be follow for `mapr`
user .
      ...
      # set the mapr ticket location for mapr user.
