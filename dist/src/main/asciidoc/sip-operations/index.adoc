...
like Number of open series ports required as (Number of SIP-node * 5 port).
For example: if we have assigned 9801 is starting port and number of sip-node is 2 then (2* 5)
, so 9801 to 9810 port will be used by spark executors.
