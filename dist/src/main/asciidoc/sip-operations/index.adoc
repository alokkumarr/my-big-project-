...
Add API [POST]: `https://{hostname}/sip/security/external/createRoleCategoryPrivilege`

This API managed by the admin only. This API contains the Roles, Categories, subCategories and Privileges which allow options for above
...
Fetch API [GET]: `https://{hostname}/sip/security/external/fetchRoleCategoryPrivilege`
