...
SAW Batch Ingestion Service will allow to pull data from remote source like *(SFTP, SCP, S3, JDBC etc).*
...
The below are salient feature for the service which are as follows:
