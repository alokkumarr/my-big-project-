...
SAW Batch Ingestion Services provides HA providing multiple instances of services up & running if one goes down
...
.Figure: SIP Alert ER Diagram
plantuml::sip-design/figure-alert-ER-diagram.pum[format=svg]
==== Apache Spark
