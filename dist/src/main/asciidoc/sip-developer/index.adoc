...
include::{snippets}/swagger-security/paths.adoc[]
include::{snippets}/swagger-security/definitions.adoc[]
include::{snippets}/swagger-security/security.adoc[]

= Semantic Service API

include::{snippets}/swagger-semantic/paths.adoc[]
include::{snippets}/swagger-semantic/definitions.adoc[]
include::{snippets}/swagger-semantic/security.adoc[]

= Scheduler Service API

include::{snippets}/swagger-scheduler/paths.adoc[]
include::{snippets}/swagger-scheduler/definitions.adoc[]
include::{snippets}/swagger-scheduler/security.adoc[]

= Observe Service API

include::{snippets}/swagger-observe/paths.adoc[]
include::{snippets}/swagger-observe/definitions.adoc[]
include::{snippets}/swagger-observe/security.adoc[]

= Proxy Service API

include::{snippets}/swagger-proxy/paths.adoc[]
include::{snippets}/swagger-proxy/definitions.adoc[]
include::{snippets}/swagger-proxy/security.adoc[]

= Workbench Service API

include::{snippets}/swagger-workbench/paths.adoc[]
include::{snippets}/swagger-workbench/definitions.adoc[]
include::{snippets}/swagger-workbench/security.adoc[]
