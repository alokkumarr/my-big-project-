...
Following are the conditions to be met in order to make it compatible with SIP
...
NOTE: Product Modules code is maintained in seperate 
https://stash.synchronoss.net/projects/BDA/repos/sip-external-widgets[repository].

Please refer to the *README* of product modules 
https://stash.synchronoss.net/projects/BDA/repos/sip-external-widgets[repository]
for further details.