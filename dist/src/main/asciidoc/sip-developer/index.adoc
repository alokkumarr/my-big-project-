...
= Batch Ingestion Service API

The Batch Ingestion Service allows clients to CRUD & schedule events for
ingestion.

include::{snippets}/apidoc-batch/paths.adoc[]
include::{snippets}/apidoc-batch/definitions.adoc[]
include::{snippets}/apidoc-batch/security.adoc[]
