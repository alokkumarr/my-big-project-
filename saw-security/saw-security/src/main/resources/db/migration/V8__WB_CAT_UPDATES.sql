...
-- Generic statement for privilege insertion
@PRIV_INS_STMT = 'INSERT INTO `PRIVILEGES` (`CUST_PROD_SYS_ID`, `CUST_PROD_MOD_SYS_ID`, `CUST_PROD_MOD_FEATURE_SYS_ID`, `ROLE_SYS_ID`, `ANALYSIS_SYS_ID`, `PRIVILEGE_CODE`, `PRIVILEGE_DESC`, `ACTIVE_STATUS_IND`, `CREATED_DATE`, `CREATED_BY`) VALUES 
('1', @CUST_PROD_MOD_SYS_ID, @CUST_PROD_MOD_FEATURE_SYS_ID, '1', '0', '128', 'All', '1', NOW(), 'admin');';
...
-- Inserting respective priviliges for above inserted categorys/sub-category
SELECT @CUST_PROD_MOD_FEATURE_SYS_ID := LAST_INSERT_ID();
EXECUTE stmt;
-- INSERT INTO `PRIVILEGES` (`CUST_PROD_SYS_ID`, `CUST_PROD_MOD_SYS_ID`, `CUST_PROD_MOD_FEATURE_SYS_ID`, `ROLE_SYS_ID`, `ANALYSIS_SYS_ID`, `PRIVILEGE_CODE`, `PRIVILEGE_DESC`, `ACTIVE_STATUS_IND`, `CREATED_DATE`, `CREATED_BY`) VALUES 
-- ('1', @CUST_PROD_MOD_SYS_ID, @CUST_PROD_MOD_FEATURE_SYS_ID, '1', '0', '128', 'All', '1', NOW(), 'admin'),
...
-- Delete previously inserted category and sub-category
