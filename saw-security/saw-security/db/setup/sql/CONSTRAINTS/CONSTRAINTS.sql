...
ALTER TABLE SEC_GROUP ADD COLUMN CUSTOMER_SYS_ID bigint(20) AFTER `SEC_GROUP_SYS_ID`;
ALTER TABLE SEC_GROUP ADD CONSTRAINT FK_CUSTOMER_SYS_ID FOREIGN KEY (`CUSTOMER_SYS_ID`) REFERENCES `CUSTOMERS` (`CUSTOMER_SYS_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE SEC_GROUP ADD CONSTRAINT UQ_CUSTOMER UNIQUE (`CUSTOMER_SYS_ID`,`SEC_GROUP_NAME`);
...
ALTER TABLE SEC_GROUP_DSK_ATTRIBUTE ADD CONSTRAINT UQ_DSK_ATTR UNIQUE (`SEC_GROUP_SYS_ID`,`ATTRIBUTE_NAME`);
