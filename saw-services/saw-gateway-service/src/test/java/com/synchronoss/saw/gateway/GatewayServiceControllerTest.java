...
public class GatewayServiceControllerTest {
	...
	@Rule
	public WireMockRule wireMockRule_1 = new WireMockRule(options().port(9093));
	...
	public void gatewayControllerTestWithAuthorizationHeader() throws Exception {
		...
		MockHttpServletRequestBuilder builder = MockMvcRequestBuilders.post(securityUrl + wireMockServer.port());
