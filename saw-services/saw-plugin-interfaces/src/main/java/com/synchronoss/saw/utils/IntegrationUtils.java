package com.synchronoss.saw.utils;
...
public final class IntegrationUtils {
	...
	public static String transponseListOfFilePatterns(
	 ...
	 * compare to other approaches, it is the fastest way to acheive the same using Java NIO library<br>
	 * @param source
	 * @param destination
	 * @throws Exception
	 */
	 ...
	 * @throws IOException
	 */
	public static File makeTarFileAndCompressGZIPFile(Collection<File> files, File output)	throws IOException
	{
	...
	private static void addFilesToCompression(TarArchiveOutputStream taos, File file, String dir)
		throws IOException
	{
		taos.putArchiveEntry(new TarArchiveEntry(file, dir + File.separator
				+ file.getName()));
		if (file.isFile()) {
