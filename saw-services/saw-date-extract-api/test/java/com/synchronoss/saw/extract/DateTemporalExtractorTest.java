...
public class DateTemporalExtractorTest {
  private DateTemporalExtractor p = new DateTemporalExtractor();

  @Test
  public void testValidPatternDDDDxDDxDD() {
      String pattern = "identify date from text : 2016 06 30";
      TemporalDateStructure date = p.parse(pattern).get(0);
  ...
  public void testInValidPatternDDDDxDDxDD() {
      ...
      List<TemporalDateStructure> date = p.parse(pattern);
