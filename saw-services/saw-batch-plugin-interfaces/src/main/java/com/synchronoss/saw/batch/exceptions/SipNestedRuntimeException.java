package com.synchronoss.saw.batch.exceptions;


public class SipNestedRuntimeException extends RuntimeException {
  ...
  public SipNestedRuntimeException(String msg) {
    super(msg);
  }
   ...
   */
  public SipNestedRuntimeException(String msg, Throwable cause) {
    super(msg, cause);
  }
  ...
  public boolean contains(Class<?> exType) {
    ...
    if (cause instanceof SipNestedRuntimeException) {
      return ((SipNestedRuntimeException) cause).contains(exType);
    } else {
      while (cause != null) {
