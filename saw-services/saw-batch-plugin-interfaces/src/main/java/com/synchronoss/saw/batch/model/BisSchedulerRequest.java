...
public class BisSchedulerRequest implements Serializable {
	...
	*/
	...
	private void readObject(java.io.ObjectInputStream in) throws IOException, ClassNotFoundException {
		...
		try {
			/*
			 * End date is optional data field and it will contains null value for existing
			 * schedules generated prior to sip v2.6.0 , handle the Optional Data Exception
			 * explicitly to identify the end of stream
			 */
