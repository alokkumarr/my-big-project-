...
public class BisJobServiceImpl implements JobService<BISSchedulerJobDetails>{
     ...
     */
    @Override
    public boolean scheduleOneTimeJob(BISSchedulerJobDetails job, Class<? extends QuartzJobBean> jobClass) {
    ...
    @Override
    public boolean scheduleCronJob(BISSchedulerJobDetails job, Class<? extends QuartzJobBean> jobClass) {
        logger.info("Request received to scheduleJob");
            ...
            for (String groupName : scheduler.getJobGroupNames()) {
                if (groupName.equalsIgnoreCase(groupkey)) {
                    for (JobKey jobKey : scheduler.getJobKeys(GroupMatcher.jobGroupEquals(groupName))) {
                        ...
                        JobDetail jobDetail = scheduler.getJobDetail(jobKey);
                        BISSchedulerJobDetails job = (BISSchedulerJobDetails) jobDetail.getJobDataMap().get(JobUtil.JOB_DATA_MAP_ID);
