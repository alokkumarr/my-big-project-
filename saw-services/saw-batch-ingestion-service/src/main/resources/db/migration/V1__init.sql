...
(
  ...
  CHANNEL_METADATA  JSON COLLATE utf8_unicode_ci NOT NULL,
...
(
  ...
  CREATED_DATE      DATETIME NULL,
  CREATED_BY        VARCHAR(255) COLLATE utf8_unicode_ci NOT NULL,
  ROUTE_METADATA    JSON COLLATE utf8_unicode_ci NOT NULL,
...
MFL_FILE_VALID_STATUS	VARCHAR(255) COLLATE utf8_unicode_ci,
DATE_OF_ENTRY	DATETIME NOT NULL,
DATE_OF_CHANGE	DATETIME NOT NULL,
MFLD_PROCESS_STATE TEXT COLLATE utf8_unicode_ci,
)ENGINE=InnoDB;
