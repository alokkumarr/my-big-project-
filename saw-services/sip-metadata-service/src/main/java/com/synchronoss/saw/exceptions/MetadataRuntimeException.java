...
public class MetadataRuntimeException extends RuntimeException {
   ...
   */
  public MetadataRuntimeException(String msg) {
    super(msg);
  }
   ...
   */
  public MetadataRuntimeException(String msg, Throwable cause) {
    super(msg, cause);
  }
  ...
  public boolean contains(Class<?> exType) {
    ...
    if (cause instanceof MetadataRuntimeException) {
      return ((MetadataRuntimeException) cause).contains(exType);
    } else {
      while (cause != null) {
