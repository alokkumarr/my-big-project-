...
/**
 * @author spau0004 This class is used to perform CRUD operation for the
 *         semantic metadata The requests are JSON documents in the following
 *         formats
 */
@RestController
...
public class SAWSemanticController {
	 ...
	 */
	@RequestMapping(value = "/{projectId}/create", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	@ResponseStatus(HttpStatus.CREATED)
	public SemanticNode addSemantic(@PathVariable(name = "projectId", required = true) String projectId,
	 ...
	 */
	@RequestMapping(value = "/{projectId}/{Id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	@ResponseStatus(HttpStatus.OK)
	public SemanticNode readSemantic(@PathVariable(name = "projectId", required = true) String projectId,
		...
		try {
			...
			logger.trace("Semantic retrieved successfully : {}", objectMapper.writeValueAsString(responseObjectFuture));
	 ...
	 */
	@RequestMapping(value = "/{projectId}/{Id}", method = RequestMethod.PUT, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	@ResponseStatus(HttpStatus.OK)
	public SemanticNode updateSemantic(@PathVariable(name = "projectId", required = true) String projectId,
		...
		try {
			...
			logger.trace("Semantic updateded successfully : {}", objectMapper.writeValueAsString(responseObjectFuture));
	 ...
	 */
	@RequestMapping(value = "/{projectId}/{Id}", method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	@ResponseStatus(HttpStatus.OK)
	public SemanticNode deleteSemantic(@PathVariable(name = "projectId", required = true) String projectId,
			@PathVariable(name = "Id", required = true) String Id) throws JSONMissingSAWException {
		...
		try {
			...
			logger.trace("Semantic deleted successfully : {}", objectMapper.writeValueAsString(responseObjectFuture));
	 ...
	 */
	@RequestMapping(value = "/{projectId}/filter", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	@ResponseStatus(HttpStatus.OK)
	public SemanticNodes searchSemantic(@PathVariable(name = "projectId", required = true) String projectId,
			@RequestParam Map<String, String> queryMap, @RequestHeader Map<String, String> headers)
			throws JSONMissingSAWException {
		SemanticNodes responseObjectFuture = null;
		ObjectMapper objectMapper = new ObjectMapper();
		try {
			SemanticNode requestBody = objectMapper.readValue(objectMapper.writeValueAsString(queryMap),
					SemanticNode.class);
	...
	/**
	 * This method is used to list the semantic entities. This will be deprecated
	 * after re-factoring of transport service
	 */
	@RequestMapping(value = "/md", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	@ResponseStatus(HttpStatus.OK)
	public BackCompatibleStructure searchSemanticWithOutArtifacts(@RequestParam Map<String, String> queryMap,
