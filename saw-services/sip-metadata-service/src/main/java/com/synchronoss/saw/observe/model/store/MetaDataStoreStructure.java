...
public class MetaDataStoreStructure {
    ...
    public enum Action {
        ...
        CREATE("create"), DELETE("delete"), READ("read"), UPDATE("update"), SEARCH("search");
    ...
    public enum Category {
        ...
        DATA_SET("DataSet"), TRANSFORMATION("Transformation"), DATA_POD("DataPod"), DATA_SEGMENT(
            "DataSegment"), USER_INTERFACE("PortalDataSet");
