...
@JsonPropertyOrder({"category", "action", "xdf-root", "output", "id", "query", "source"})
public class MetaDataStoreStructure {
  ...
  public enum Action {
    ...
    UPDATE("update"),
    SEARCH("search");
    private static final Map<String, MetaDataStoreStructure.Action> CONSTANTS =
        new HashMap<String, MetaDataStoreStructure.Action>();
  ...
  public enum Category {
    ...
    private static final Map<String, MetaDataStoreStructure.Category> CONSTANTS =
        new HashMap<String, MetaDataStoreStructure.Category>();
