...
CREATE TABLE `DATAPOD_DETAILS` (
    ...
    `ALERT_CUSTOMER_SYS_ID` INT(11) DEFAULT NULL,
    `CREATED_TIME` DATETIME DEFAULT NULL COMMENT 'Datapod created time',
    `CREATED_BY` VARCHAR(45) DEFAULT NULL COMMENT 'Datapod created by user',
...
CREATE TABLE `ALERT_RULES_DETAILS` (
    ...
    `RULE_NAME` VARCHAR(100) NOT NULL COMMENT 'Alert Rule Name',
    `RULE_DESCRIPTIONS` VARCHAR(250) DEFAULT NULL COMMENT 'Alert Rule Descriptions',
...
CREATE TABLE `ALERT_TRIGGER_DETAILS_LOG` (
    ...
    `ALERT_STATE` ENUM('INPROGRESS', 'COMPLETED', 'FAILED', 'RUNNING', 'WAITING') NOT NULL,
