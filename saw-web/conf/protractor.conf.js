...
const implicitlyWait = webpackHelper.distRun() ? 20000 : 15000;
const extendedImplicitlyWait = webpackHelper.distRun() ? 30000 : 20000;//20000 // = 20 sec; Sometimes element will not
                                                                          // appear so fast

/**
 * Defines the maximum amount of time to wait for a condition
 */
const fluentWait = webpackHelper.distRun() ? 20000 : 15000;
