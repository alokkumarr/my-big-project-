...
describe('Running create and delete dashboards with Snapshot KPIS in dashboards/createAndDeleteDashboardsWithActualVSTargetKPI.test', () => {
    ...
    using(testDataReader.testData['CREATEDELETEDASHBOARDSWITHACTUALVSTARGETKPI']['dashboards']
     ? testDataReader.testData['CREATEDELETEDASHBOARDSWITHACTUALVSTARGETKPI']['dashboards'] 
     : {}, (data, id) => {
         it(`${id}:${data.description}`, () => {
            ...
            testId: id,
            data: data,
            feature: 'CREATEDELETEDASHBOARDSWITHACTUALVSTARGETKPI',
