...
describe('Running create and delete dashboards with charts in dashboards/createAndDeleteDashboardsWithChartsWithGlobalFilter.test.js', () => {
    ...
    beforeAll(() => {
      logger.info('Starting dashboards/createAndDeleteDashboardsWithChartsWitGlobalFilter.test.js.....');
    ...
    afterEach(done => {
      ...
      using(testDataReader.testData['CREATEDELETEDASHBOARDSWITHCHARTSWITHGLOBALFILTERS']['globalfilters']
      ? testDataReader.testData['CREATEDELETEDASHBOARDSWITHCHARTSWITHGLOBALFILTERS']['globalfilters']
      : {}, (data, id) => {
          it(`${id}:${data.description}`, () => {
            ...
            try{
                ...
                let analysis = new ObserveHelper().addAnalysisByApi(host, token, name, description, Constants.CHART, subType, data.filters);         
            ...
            testId: id,
            data: data,
            feature: 'CREATEDELETEDASHBOARDSWITHCHARTSWITHGLOBALFILTERS',
