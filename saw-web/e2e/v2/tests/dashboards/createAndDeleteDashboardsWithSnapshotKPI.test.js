  ...
  : {}, (data, id) => {
      it(`${id}:${data.description}`, ()=> {
        ...
        try{
          ...
          dashboardDesigner.clickOnMetricByName(metricName);
          ...
          dashboardDesigner.clickOnDatePreSelectValue(data.kpiInfo.date);
          dashboardDesigner.clickOnDatePreSelect();
          dashboardDesigner.clickOnDatePreSelectValue(data.kpiInfo.filter);
          dashboardDesigner.clickOnAggregationSelect();
          dashboardDesigner.clickOnAggregationSelectValue(data.kpiInfo.primaryAggregation);
