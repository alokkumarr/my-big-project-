...
export const parser_preview = {
  ...
  description:
    'Its delimited file inspecting to verify & understand the content of file',
  fields: [
    {
      name: 'DOJ',
      type: 'date',
  ...
  samplesParsed: [
    ...
    },
    {
      ...
      Salary: '84.70',
      Resignation:
        'Alexey has resigned & his last day was on 2018-Jan-31 15:08:00'
    }
  ]
};
...
export const SQL_AQCTIONS = [
  ...
  {
    statement:
      'SELECT Count(*) AS DistinctCountrie FROM (SELECT DISTINCT Country FROM Customers);'
  }
];
