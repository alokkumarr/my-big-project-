...
describe('Workbench Service', () => {
  ...
  it('should return error if staging data request failed', () => {
    workbenchService
      .getStagingData(`${this.wbAPI}/${this.userProject}/raw/directory`)
      .subscribe((res: any) => {
  ...
  it('should get the staging data', () => {
    ...
    workbenchService
      .getStagingData(`${this.wbAPI}/${userProject}/raw/directory`)
      .subscribe((res: any) => {
  ...
  it('should return error if raw preview data request failed', () => {
    workbenchService
      .getRawPreviewData(`${this.wbAPI}/${userProject}/raw/directory/preview`)
      .subscribe((res: any) => {
  ...
  it('should get the rawPreview data', () => {
  ...
  it('should return error if parsed preview data request failed', () => {
    workbenchService
      .getParsedPreviewData(
  ...
  it('should get the parsed preview data', () => {
