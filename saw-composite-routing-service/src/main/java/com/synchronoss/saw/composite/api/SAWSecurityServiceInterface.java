...
public interface SAWSecurityServiceInterface {
	...
	@RequestMapping (method = RequestMethod.POST, value = "/saw-security/doAuthenticate", consumes = MediaType.APPLICATION_JSON_UTF8_VALUE, 
			produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	public LoginResponse login (@RequestBody LoginDetails loginDetails);
	
	@RequestMapping (method = RequestMethod.POST, value = "/saw-security/auth/doLogout", produces = "application/json")
	public String logout (@RequestBody String ticketID) throws HttpClientErrorException;
	
	@RequestMapping (method = RequestMethod.POST, value = "/saw-security/auth/changePassword", produces = "application/json")
	public Valid change (@RequestBody ChangePasswordDetails changePasswordDetails)throws HttpClientErrorException;

	@RequestMapping (method = RequestMethod.POST, value = "/saw-security/resetPassword", produces = "application/json")
	public Valid reset (@RequestBody ResetPwdDtls resetPwdDtls)throws HttpClientErrorException;

	@RequestMapping (method = RequestMethod.POST, value = "/saw-security/auth/validateToken", produces = "application/json")
	public Valid validate (@RequestBody LoginDetails loginDetails)throws HttpClientErrorException;

	@RequestMapping (method = RequestMethod.POST, value = "/saw-security/getDefaults", produces = "application/json")
	public LoginResponse defaults (@RequestBody LoginDetails loginDetails)throws HttpClientErrorException;
