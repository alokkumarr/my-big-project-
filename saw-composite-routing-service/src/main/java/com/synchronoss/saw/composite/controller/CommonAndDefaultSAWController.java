...
public class CommonAndDefaultSAWController {
	...
	@Autowired
	public CommonAndDefaultSAWController(LoadBalancerClient loadBalancerClient) {
	...
	public RoutingPayload menu(@RequestBody RoutingPayload payload, @RequestHeader HttpHeaders headers) 
	{
		...
		String security_url = serviceUtils.getSAWAddress(this.loadBalancerClient, sawCompositeProperties.getSecurityContext()) + "/auth/validateToken";
