...
class DashboardDesigner extends ChooseWidget {
  constructor() {
    super();
    this._addWidgetButton = element(
      by.css(`[e2e='dashboard-add-widget-button']`)
    );
    this._saveButton = element(
      by.css('button[e2e="dashboard-designer-save-button"]')
    );
    this._filterButton = element(
      by.css('button[e2e="dashboard-designer-filters-button"]')
    );
  }
