    ...
    (data, id) => {
      it(`${id}:${data.description}`, () => {
        try {
          ...
          //Immediate Report
          const immediateReportName = `Immediate Schedule Report`;
          const immediateReportDescription = `Immediate Schedule Report ${new Date().toString()}`;
    ...
    (data, id) => {
      it(`${id}:${data.description}`, () => {
        try {
          ...
          loginPage.loginAs(data.user, /analyze/);
          //Hourly Report
          const hourlyReportName = `Hourly Schedule Report`;
          const hourlyReportDescription = `Hourly Schedule Report  ${new Date().toString()}`;
    ...
    (data, id) => {
      it(`${id}:${data.description}`, () => {
        try {
          ...
          //Weekly Report
          const weeklyReportName = `Weekly Schedule Report`;
          const weeklyReportDescription = `Weekly Schedule Report ${new Date().toString()}`;
    ...
    (data, id) => {
      it(`${id}:${data.description}`, () => {
        try {
          ...
          //EveryDay Report
          const everyDayReportName = `EveryDay Schedule Report`;
          const everyDayReportDescription = `EveryDay Schedule Report ${new Date().toString()}`;
    ...
    (data, id) => {
      it(`${id}:${data.description}`, () => {
        try {
          ...
          //EveryWeekDay Report
          const everyWeekDayReportName = `Every Weekday Report`;
          const everyWeekDayReportDescription = `Every Weekday Report ${new Date().toString()}`;
    ...
    (data, id) => {
      it(`${id}:${data.description}`, () => {
        try {
          ...
          const yearlyMonthWiseReportName = `Yearly MonthWise Report`;
          const yearlyMonthWiseReportDescription = `Yearly MonthWise Schedule Report ${new Date().toString()}`;
    ...
    (data, id) => {
      it(`${id}:${data.description}`, () => {
        try {
          ...
          const yearlyWeekWiseReportName = `Yearly WeekWise Report`;
          const yearlyWeekWiseReportDescription = `Yearly WeekWise Schedule Report ${new Date().toString()}`;
    ...
    (data, id) => {
      it(`${id}:${data.description}`, () => {
        try {
          ...
          loginPage.loginAs(data.user, /analyze/);
          //Yearly MonthWise Report
          const monthlyDayWiseReportName = `Monthly DayWise Report`;
          const monthlyDayWiseReportDescription = `Monthly DayWise Schedule Report ${new Date().toString()}`;
    ...
    (data, id) => {
      it(`${id}:${data.description}`, () => {
        try {
          ...
          loginPage.loginAs(data.user, /analyze/);
          //Yearly MonthWise Report
          const monthlyWeekWiseReportName = `Monthly DayWise Report`;
          const monthlyWeekWiseReportDescription = `Monthly DayWise Schedule Report ${new Date().toString()}`;
