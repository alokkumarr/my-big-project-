...
# SAW Observe: Creating a table on MapRDB to store Observe module metadata

    $ ssh <saw-services-host>
    cd /opt/bda/saw-observe-service/bin
    execute create-metadata.sh (This table should be created for the first time)
