...
ALTER TABLE SEC_GROUP_DSK_ATTRIBUTE_MODEL
      ADD CONSTRAINT FK_SEC_GROUP_SYS_ID
		  FOREIGN KEY (SEC_GROUP_SYS_ID) REFERENCES SEC_GROUP(SEC_GROUP_SYS_ID)
      ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE SEC_GROUP_DSK_ATTRIBUTE_MODEL
      ADD CONSTRAINT FK_SEC_GROUP_DSK_PARENT_ID
		  FOREIGN KEY (SEC_GROUP_DSK_PARENT_ID) REFERENCES SEC_GROUP_DSK_ATTRIBUTE_MODEL(SEC_GROUP_DSK_ATTRIBUTE_SYS_ID)
      ON DELETE CASCADE ON UPDATE CASCADE;
