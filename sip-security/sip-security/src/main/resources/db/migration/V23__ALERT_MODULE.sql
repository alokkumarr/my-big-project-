...
SELECT CUST_PROD_MOD_SYS_ID into l_CUSTOMER_PROD_MOD_SYS_ID_1 FROM CUSTOMER_PRODUCT_MODULE_FEATURES WHERE FEATURE_CODE=concat(l_customer_code, 'VIEWALERT');
select l_CUSTOMER_PROD_MOD_SYS_ID_1;

SELECT CUST_PROD_MOD_FEATURE_SYS_ID into l_CUST_PROD_MOD_FEATURE_SYS_ID_1 FROM CUSTOMER_PRODUCT_MODULE_FEATURES WHERE FEATURE_CODE=concat(l_customer_code, 'VIEWALERT');
select l_CUST_PROD_MOD_FEATURE_SYS_ID_1;
...
SELECT CUST_PROD_MOD_SYS_ID into l_CUSTOMER_PROD_MOD_SYS_ID_1 FROM CUSTOMER_PRODUCT_MODULE_FEATURES WHERE FEATURE_CODE=concat(l_customer_code, 'CONFIGUREALERT');
select l_CUSTOMER_PROD_MOD_SYS_ID_1;

SELECT CUST_PROD_MOD_FEATURE_SYS_ID into l_CUST_PROD_MOD_FEATURE_SYS_ID_1 FROM CUSTOMER_PRODUCT_MODULE_FEATURES WHERE FEATURE_CODE=concat(l_customer_code, 'CONFIGUREALERT');
select l_CUST_PROD_MOD_FEATURE_SYS_ID_1;
