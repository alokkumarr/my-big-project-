...
DELETE FROM CUSTOMER_PRODUCT_MODULE_FEATURES WHERE CUST_PROD_MOD_FEATURE_SYS_ID = @l_cust_prod_mod_feature_sys_id + 1 AND FEATURE_CODE like '%RTIS000001';
...
DELETE FROM CUSTOMER_PRODUCT_MODULE_FEATURES WHERE CUST_PROD_MOD_FEATURE_SYS_ID = @l_cust_prod_mod_feature_sys_id + 2 AND FEATURE_CODE like '%RtisReg001';
...
DELETE FROM CUSTOMER_PRODUCT_MODULE_FEATURES WHERE CUST_PROD_MOD_FEATURE_SYS_ID = @l_cust_prod_mod_feature_sys_id + 3 AND FEATURE_CODE like '%RtisAppKey001';
