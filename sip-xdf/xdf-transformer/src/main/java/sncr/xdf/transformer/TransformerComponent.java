...
//2. Read input datasets
    ...
    public static ComponentConfiguration analyzeAndValidate(String cfgAsStr) throws Exception {
        ...
        if (!valid) throw new XDFException(XDFReturnCode.CONFIG_ERROR,
        ...
        if (!valid) throw new XDFException(XDFReturnCode.CONFIG_ERROR, "Incorrect configuration: dataset parameter with name 'output/rejected' does not exist .");
