 ...
 * due to the serialization issue after adding new field in this class. Before editing this class
 * Please read below Instruction carefully. 1) Any new field addition in this class should be
 * inserted in last. 2) Do not modify the existing order of fields in readObject and writeObject
 * method, add the fields at the end. 3) If any dataType changes for existing fields, needs to be
 * handled in readObject section using if else condition to make this class backward compatible. 4)
 * Do not change the serialVersionUID while editing this class, changing this value will cause
...
public class SchedulerJobDetail implements Serializable {
  ...
  private void writeObject(java.io.ObjectOutputStream out) throws IOException {
    ...
    if (ftp != null && ftp.size() > 0) out.writeObject(ftp);
  ...
  private void readObject(java.io.ObjectInputStream in) throws IOException, ClassNotFoundException {
    ...
    try {
      ...
      if (endDt instanceof Date) endDate = (Date) endDt;
