...
public class WorkbenchExecutorJob {
	   ...
	   */
	  public WorkbenchExecutorJob(String root, String project, String component, String config) {
	    this.root = root;
	   ...
	   */
	  public WorkbenchExecutorJob(NGContext ngctx) {
	    this.root = null;
	    this.project = null;
	    this.component = null;
	    this.config = null;
	  ...
	  public Integer process(JobContext jobContext) throws Exception {
