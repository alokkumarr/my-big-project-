...
public class PivotParametersUnitTest {
  ...
  public void chartNodeNotNullTest(){
    ...
    try {
      ...
      com.synchronoss.querybuilder.model.pivot.SqlBuilderPivot sqlBuilderNodePivot =
          objectMapper.treeToValue(objectNode1, com.synchronoss.querybuilder.model.pivot.SqlBuilderPivot.class);
