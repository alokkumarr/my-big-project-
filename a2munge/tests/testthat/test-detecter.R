...
# dat6_tbl <- copy_to(sc, mutate(dat6, date_time = as.character(date)), overwrite = TRUE)
# 
# # Format Spark tables
# dat4_tbl <- mutate(dat4_tbl, date_time = to_utc_timestamp(date_time, "UTC"))
# dat6_tbl <- mutate(dat6_tbl, date_time = to_utc_timestamp(date_time, "UTC"))
# 
# 
# 
# # Apply Detecter ----------------------------------------------------------
